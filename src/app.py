...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice drills and team play for the school soccer squad",
    ...
    "Drama Club": {
        "description": "Prepare scenes, monologues, and performances for school events",
    ...
    "Debate Team": {
        "description": "Practice persuasive speaking and research for debate competitions",
